...
metaLinks:
  alternates:
    - https://app.gitbook.com/s/bS7QQPLgDzMuaC61tcij/resources/gitbook-ui
---
...
* **Integrations**\
  GitBook [integrations](https://github.com/Class-Documentation/public-docs-go/blob/main/content-editor/editor/broken-reference/README.md) supercharge your content, allowing you to embed more into your pages, or add information to your knowledge base from other apps.
* **Docs sites**\
...
* **The Share menu**\
  Allows you to publish and share your space. You can also invite others to [collaborate](https://github.com/Class-Documentation/public-docs-go/blob/main/content-editor/editor/broken-reference/README.md) through this menu.
* **Variables**\
