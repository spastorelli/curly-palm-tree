...
metaLinks:
  alternates:
    - https://app.gitbook.com/s/bS7QQPLgDzMuaC61tcij/collaboration/pdf-export
---
...
{% include "../docs/.gitbook/includes/premium-and-ultimate-hint.md" %}

To enable or disable PDF export for visitors to your [published docs site](https://github.com/Class-Documentation/public-docs-go/blob/main/collaboration/broken-reference/README.md), open the docs site’s dashboard, open the **Customization** tab, and navigate to **Configure → Page actions**. From there, you can toggle **Export as PDF** on or off.
