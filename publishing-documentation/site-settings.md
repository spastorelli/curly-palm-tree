...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bS7QQPLgDzMuaC61tcij/publishing-documentation/site-settings
---

# Site settings

{% include "../docs/.gitbook/includes/customization-premium-and-ultimate-hint.md" %}
