...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bS7QQPLgDzMuaC61tcij/publishing-documentation/authenticated-access/setting-up-a-custom-backend
---
...
{% include "../../docs/.gitbook/includes/adaptive-content-development-hint.md" %}
