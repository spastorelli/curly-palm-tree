...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bS7QQPLgDzMuaC61tcij/publishing-documentation/gitbook-ai-assistant
---

# GitBook Assistant

{% include "../docs/.gitbook/includes/ultimate-hint.md" %}
...
* [Using with authenticated docs](embedding/using-with-authenticated-docs.md) – Required if your docs need sign-in
